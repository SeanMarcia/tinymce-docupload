...
Gem::Specification.new do |s|
  ...
  s.summary     = %q{TinyMCE plugin for taking document uploads in Rails >= 3.2}
  s.description = %q{TinyMCE plugin for taking document uploads in Rails >= 3.2. Image storage is handled manually, so works with everything.}
